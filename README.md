...
the right order to make more profit through tips. You'll be able to purchase ad 
levels, which increase the number of customers you serve, and recipes, which 
have different selling prices. There's no set end of this game, but you can quit 
when you're at the menu or baking (see: Baking).
...
### Determining Profit
**Tips**: Each order's score divided by 2. You'll see your total tips at the end 
of each day.
...
**Total profit**: Total profit from every day.
...
### Inputs
Inputs are case insensitive and can be re-entered an unlimited amount of times, 
except while baking.
...
**simulator_main.py**: The main game file that contains all necessary classes, 
functions, and methods to run Bakery Simulator.

## Project Draft Files
**create_customers.py**: Ethan Gustave's draft of the create_customers function.

**game_demo.py**: Presentation live demo.
...
**shop.py**: Draft of the Shop class. First draft written by Ethan Gustave. 
Second draft written by Angela Kyuk and edited by Ethan Gustave.
...
Used by Angela Kyuk. This is the official Python website that has descriptions 
and tutorials for built-in types. I used this website to learn more about the 
.join() string method and case manipulation, specifically .capitalize().
...
Used by Angela Kyuk. This website has tutorials for several coding languages. 
I used this website to learn how to format numbers as currency, particularly 
how to always have two decimal points

Python Join Two Lists. (n.d.). Retrieved May 5, 2026, from https://www.w3schools.com/python/gloss_python_join_lists.asp

Used by Angela Kyuk. This website has tutorials for several coding languages. I 
used this website to recall how to set a variable to two concatenated lists 
using `+`.